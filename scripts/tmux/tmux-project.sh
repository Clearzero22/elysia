...
# ========================================
# Universal Tmux Development Environment
# Usage: ./tmux-project.sh [project-directory]
...
show_help() {
    ...
    echo "  -w, --windows   Specify number of windows (default: 8)"
    echo ""
...
echo "========================================"
echo " Universal Dev Environment (8 Windows)"
echo "========================================"
echo ""
...
# Select first window and Claude pane
